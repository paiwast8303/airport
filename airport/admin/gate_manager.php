...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="container-fluid">
    <div class="row g-3">
        <div class="col-md-6">
            <label for="First name" class="form-label">Gate:</label>
            <input name="fname" type="text" class="form-control" id="name" >
        </div>
        <div class="col-md-6">
            <label for="Last name" class="form-label">Location:</label>
        ...
        <div class="col-md-6">
            ...
            <select name="role" class="form-control" id="role">
              ...
              <option value="Gate Manger">Close</option>
            </select>
        </div>
      ...
      <div class="modal-footer">
        ...
        <button name="adds" type="submit" class="btn btn-primary" form="adminForm">Add</button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary add_f"   data-bs-toggle="modal" data-bs-target="#addsadmins" data-bs-whatever="@mdo">Edit</button>
